...
- reuse these assets in other projects
- redistribute them separately
- modify and distribute them outside this project

Permission must be obtained from the author for any use outside this project.